...
VARS = [
    ("Running guest-to-host benchmark (R2H)", r"\microbenchFuncLatencyRtoH"),
    ("Running host-to-guest benchmark (H2R)", r"\microbenchFuncLatencyHtoR"),
    ("Running monolithic intra-component benchmark", r"\microbenchFuncLatencyMono"),
]
