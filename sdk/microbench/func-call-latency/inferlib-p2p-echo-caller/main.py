"""
Microbenchmark: cross-component echo() call latency (Python-to-Python).

Measures the per-call overhead of invoking an echo function exported by
a Python callee component from a Python caller component, going through
...
def main() -> None:
    ...
    print(f"Cross-component echo() call benchmark (P2P)")
