use crate::exports::inferlib4::inference::models::{GuestModel, GuestTokenizer};

use inferlib4_engine_bindings::inferlet::core::common::Model as HostModel;
use inferlib4_engine_bindings::inferlet::core::runtime::{get_all_models, get_model};
use inferlib4_engine_bindings::inferlet::core::tokenize::{
...
impl GuestModel for ModelImpl {
    fn get_by_name(name: String) -> Option<crate::exports::inferlib4::inference::models::Model> {
        Model::get_by_name(&name).map(|model| {
            crate::exports::inferlib4::inference::models::Model::new(ModelImpl {
                inner: RefCell::new(model),
            })
        })
    }

    fn get_auto() -> crate::exports::inferlib4::inference::models::Model {
        crate::exports::inferlib4::inference::models::Model::new(ModelImpl {
    ...
    fn get_tokenizer(&self) -> crate::exports::inferlib4::inference::models::Tokenizer {
        let tokenizer = self.inner.borrow().get_tokenizer();
        crate::exports::inferlib4::inference::models::Tokenizer::new(TokenizerImpl {
