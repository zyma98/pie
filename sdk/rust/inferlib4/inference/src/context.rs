...
use crate::exports::inferlib4::inference::inference::{GuestContext, SamplerConfig, StopConfig};
...
impl GuestContext for ContextImpl {
    fn new(wit_model: crate::exports::inferlib4::inference::models::ModelBorrow<'_>) -> Self {
    ...
    fn from_imported_state(
        wit_model: crate::exports::inferlib4::inference::models::ModelBorrow<'_>,
        kv_page_ptrs: Vec<u32>,
        prefix_tokens: Vec<u32>,
        kv_page_last_len: u32,
    ) -> crate::exports::inferlib4::inference::inference::Context {
        let model_impl: &ModelImpl = wit_model.get();
        let model = model_impl.inner.borrow().clone();
        ...
        crate::exports::inferlib4::inference::inference::Context::new(ContextImpl {
            inner: Rc::new(RefCell::new(inner)),
        })
    }
    ...
    fn fork(&self) -> crate::exports::inferlib4::inference::inference::Context {
