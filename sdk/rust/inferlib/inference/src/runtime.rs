...
pub(crate) fn get_arguments() -> Vec<String> {
    inferlib_engine_bindings::inferlet::core::runtime::get_arguments()
}

pub(crate) fn set_return(value: String) {
...
pub(crate) fn get_all_models_with_traits(traits: Vec<String>) -> Vec<String> {
...
pub(crate) fn debug_query(query: String) -> String {
