use inferlib4_inference_bindings::{ChatFormatter, Context, Model, SamplerConfig, StopConfig};
use inferlib4_run_bindings::{Args, Result, anyhow};
use std::time::Instant;

#[inferlib4_macros::main]
