...
async fn __pie_main_inner(_args: inferlib_run_bindings::Args) -> inferlib_run_bindings::Result<String> {
...
impl __pie_export::exports::pie::testapp::run::Guest for __PieMain {
    fn run() -> core::result::Result<(), String> {
        let result = inferlib_run_bindings::block_on(async {
            let args = inferlib_run_bindings::Args::from_vec(Vec::new());
