...
def future_write(
    ty: int, future: int, value: Any
) -> Result[tuple[int, int], tuple[int, int]]: ...
def future_drop_readable(ty: int, future: int) -> None: ...
def future_drop_writable(ty: int, future: int) -> None: ...
def stream_read(
    ty: int, stream: int, max_count: int
) -> Result[tuple[int, bytes | list[Any]], tuple[int, int]]: ...
def stream_write(
    ty: int, stream: int, values: bytes | list[Any]
) -> Result[tuple[int, int], tuple[int, int]]: ...
