...
use crate::{bindings2, kvs, server};
use std::mem;
...
impl bindings2::pie::inferlet::core::Host for InstanceState {
...
impl bindings2::pie::inferlet::core::HostModel for InstanceState {
...
impl bindings2::pie::inferlet::core::HostQueue for InstanceState {
    ...
    async fn set_priority(
        &mut self,
        this: Resource<Queue>,
        priority: bindings2::pie::inferlet::core::Priority,
    ) -> anyhow::Result<()> {
        let inst_id = self.id();
        let queue = self.table().get(&this)?;
        Command::SetStreamPriority {
            ...
            priority: match priority {
                bindings2::pie::inferlet::core::Priority::High => StreamPriority::High,
                bindings2::pie::inferlet::core::Priority::Normal => StreamPriority::Normal,
                bindings2::pie::inferlet::core::Priority::Low => StreamPriority::Low,
            },
        }
        .dispatch(queue.service_id)?;
        Ok(())
...
impl bindings2::pie::inferlet::core::HostSynchronizationResult for InstanceState {
    async fn pollable(
        &mut self,
...
impl bindings2::pie::inferlet::core::HostReceiveResult for InstanceState {
    async fn pollable(
        &mut self,
...
impl bindings2::pie::inferlet::core::HostSubscription for InstanceState {
    async fn pollable(
        &mut self,
