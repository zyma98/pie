...
async def main(args):
    ...
    async with PieClient(args.server_uri) as client:
        ...
        append_log('./logs/test_14_beamsearch_pie.json', {
...
if __name__ == "__main__":
    ...
    benchmark_group.add_argument("--program-name", type=str, default="beam_search", help="Name of the WASM program file (without .wasm extension).")
    ...
    wasm_args_group.add_argument("--beam-size", type=int, default=5, help="Argument for WASM program: beam size")
...
#
# --- ✅ Benchmark Complete ---
# Total Time Taken:       6258.26 milliseconds
# Throughput:             20.45 requests/second
# --------------------------