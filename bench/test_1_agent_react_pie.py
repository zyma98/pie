...
async def main(args):
    ...
    async with PieClient(args.server_uri) as client:
        ...
        append_log('./logs/test_1_agent_react_pie.json', {
...
if __name__ == "__main__":
    ...
    benchmark_group.add_argument("--program-name", type=str, default="agent_react", help="Name of the WASM program file (without .wasm extension).")
    ...
    wasm_args_group.add_argument("--function-call-delay", type=int, default=100, help="Argument for WASM program: delay for function calls (in ms).")

    args = parser.parse_args()
    asyncio.run(main(args))

# --- ✅ Benchmark Complete ---
# Total Time Taken:       4275.80 milliseconds
# Throughput:             29.94 requests/second
# --------------------------