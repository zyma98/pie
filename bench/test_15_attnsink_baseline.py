...
def main(args: argparse.Namespace):
    ...
    append_log('./logs/test_15_attnsink_baseline.json', {
...
if __name__ == "__main__":
    ...
    server_group.add_argument("--backend", type=str, default="tensorrt-llm", help="The backend to use for the LLM (e.g., 'vllm').")
