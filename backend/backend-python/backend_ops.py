...
class BackendOps:
    ...
    def decode_image(self, image_blob: bytes, dtype: torch.dtype, device: str) -> torch.Tensor:
        ...
        raise NotImplementedError(f"decode_image not implemented for {self.backend_name}")

    # Sampling operations
    def sampling_from_probs(self, probs: torch.Tensor) -> torch.Tensor:
        """Sample tokens from probability distribution."""
        raise NotImplementedError(f"sampling_from_probs not implemented for {self.backend_name}")
    ...
    def top_p_sampling_from_probs(self, probs: torch.Tensor, top_p: torch.Tensor) -> torch.Tensor:
        ...
        raise NotImplementedError(f"top_p_sampling_from_probs not implemented for {self.backend_name}")
    ...
    def top_k_sampling_from_probs(self, probs: torch.Tensor, top_k: torch.Tensor) -> torch.Tensor:
        ...
        raise NotImplementedError(f"top_k_sampling_from_probs not implemented for {self.backend_name}")
    ...
    def min_p_sampling_from_probs(self, probs: torch.Tensor, min_p: torch.Tensor) -> torch.Tensor:
        ...
        raise NotImplementedError(f"min_p_sampling_from_probs not implemented for {self.backend_name}")
    ...
    def top_k_top_p_sampling_from_probs(self, probs: torch.Tensor, top_k: torch.Tensor, top_p: torch.Tensor) -> torch.Tensor:
        ...
        raise NotImplementedError(f"top_k_top_p_sampling_from_probs not implemented for {self.backend_name}")
...
class FlashInferOps(BackendOps):
    ...
    def top_k_top_p_sampling_from_probs(self, probs: torch.Tensor, top_k: torch.Tensor, top_p: torch.Tensor) -> torch.Tensor:
        ...
        return self.ops.sampling.top_k_top_p_sampling_from_probs(probs, top_k=top_k, top_p=top_p)
