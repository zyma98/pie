...
def heartbeat_thread(
    heartbeat_request_queue: queue.Queue, response_queue: queue.Queue, service: Runtime
) -> None:
...
def worker_thread(
    work_request_queue: queue.Queue, response_queue: queue.Queue, service: Runtime
) -> None:
