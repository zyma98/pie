...
//     let reporter = ExceptionDispatcher::new(report_tx);
//
//     let l4m_backend = SimulatedBackend::new(service::l4m::Simulator::new()).await?;
//     let ping_backend = SimulatedBackend::new(service::ping::Simulator::new()).await?;
//
//     let l4m = service::L4m::new(l4m_backend, reporter).await?;
//     let ping = service::Ping::new(ping_backend).await?;
//
//     let controller = ControllerBuilder::new()
//         .install_driver("llama3", l4m)
//         .install_driver("ping", ping)
//         .build();
//
//     let runtime = Runtime::new(controller.dispatcher().clone(), report_rx);
//
